...
<section class="update-product">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <input type="text" required placeholder="masukan nama produk" name="name" maxlength="100" class="box" value="<?= $fetch_products['name']; ?>">
      ...
      <span>update katagori</span>
      <select name="category" class="box" required>
         <option selected value="<?= $fetch_products['category']; ?>"><?= $fetch_products['category']; ?></option>
         <option value="Martabak Mini">Martabak Mini</option>
         <option value="Martabak Telur">Martabak Telur</option>
         <option value="Martabak Manis">Martabak Manis</option>
         <option value="Martabak Pandan">Martabak Pandan</option>
         <option value="Martabak Jagung">Martabak Jagung</option>
      </select>
